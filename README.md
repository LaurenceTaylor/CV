...
I've had an interest in coding for several years. At university I elected to take a module on vegetation modelling in R, and I found it the most enjoyable time of my degree. For a while I continued learning through the usual routes: freeCodeCamp, The Odin Project, Codecademy, edX, Codewars and others. In my previous role I approached management and secured approval to learn SQL, which enabled far better analysis of global fraud trends. It was only SQL, but it was a thrill!
